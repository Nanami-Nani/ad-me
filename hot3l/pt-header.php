...
<body id="page-top" class="index">
  ...
  <div class="padding-site">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="flags visible-xs">
            					...
            					<a href="../en"><img src="../img/en.png" class="img-responsive"></a>
                    ...
                    <li>
                      <a class="page-scroll" title="Localização | Smart Hotel Montevideo" href="./#ubicacion">Localização</a>
                    </li>
                    <li>
                      <a class="<?php echo ($selected=='habitaciones')?'selected':''; ?>" title="Quartos | Smart Hotel Montevideo" href="quartos-suites">Quartos</a>
                    </li>
                    <li>
                      <a class="page-scroll" title="Gastronomia | Smart Hotel Montevideo" href="./#servicios">Gastronomia</a>
                    </li>
                    <li>
                      <a title="Galeria | Smart Hotel Montevideo" data-gallery="site-gallery" href="../img/sections/gallery/1.jpg">Galeria</a>
                    </li>
                    <li>
                      <a class="page-scroll" title="Notícias e Promoções | Smart Hotel Montevideo" href="./#novedades">Notícias e Promoções</a>
                    </li>
                    <li>
                      <a class="page-scroll" title="Contato | Smart Hotel Montevideo" href="./#footer">Contato</a>
                    </li>
                    <div class="divider-svg visible-xs"></div>
                    <li class="dropdown visible-sm visible-md visible-lg">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        <img src="../img/pt.png" class="img-carpet"> Línguas <span class="caret"></span>
                      </a>
                      <ul class="dropdown-menu">
                        <li><a title="Español" href="../es"><img src="../img/es.png" alt="Português" class="flags">Español</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a title="English" href="../en"><img src="../img/en.png" alt="English" class="flags">English</a></li>
                      </ul>
                    </li>
                    ...
                    <li class="visible-sm visible-md visible-lg">
                      <a class="btn btn-xl" title="Reservas | Smart Hotel Montevideo" href="https://be.synxis.com/?Hotel=36383&Chain=28734&locale=pt-PT" target="_blank"><div class="extra-border">Reservas</div></a>
                    </li>
                  </ul>
            </div>
        </div>
    ...
    <div class="quick-contact">
      <a title="Reservas | Smart Hotel Montevideo" class="btn btn-xl book-now show-mobile" href="https://be.synxis.com/?Hotel=36383&Chain=28734&locale=pt-PT" target="_blank"><div class="extra-border">Reservas</div></a>
      <a title="Telefone | Smart Hotel Montevideo" class="btns show-mobile" href="tel:59842440229"><i class="fas fa-phone"></i></a>
      <a title="Email de Reservas | Smart Hotel Montevideo" class="btns show-mobile" href="mailto:info@smarthotelmontevideo.com"><i class="fas fa-envelope"></i></a>
