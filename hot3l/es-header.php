...
<head>
    ...
    <!-- Custom CSS ?v1.1 -->
    <link href="../css/site.css?v2.9" rel="stylesheet">
...
<body id="page-top" class="index">
  ...
  <div class="padding-site">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                      <a class="page-scroll" title="Ubicación | Smart Hotel Montevideo" href="./#ubicacion">Ubicación</a>
                    </li>
                    <li>
                      <a class="<?php echo ($selected=='habitaciones')?'selected':''; ?>" title="Habitaciones | Smart Hotel Montevideo" href="habitaciones">Habitaciones</a>
                    </li>
                    <li>
                      <a class="page-scroll" title="Gastronomia | Smart Hotel Montevideo" href="./#servicios">Gastronomia</a>
                    </li>
                    <li>
                      <a title="Galería | Smart Hotel Montevideo" data-gallery="site-gallery" href="../img/sections/gallery/1.jpg">Galería</a>
                    </li>
                    <li>
                      <a class="page-scroll" title="Promociones | Smart Hotel Montevideo" href="./#novedades">Promociones</a>
                    </li>
                    <li>
                      <a class="page-scroll" title="Contacto | Smart Hotel Montevideo" href="./#footer">Contacto</a>
                    </li>
                    <div class="divider-svg visible-xs"></div>
                    <li class="dropdown visible-sm visible-md visible-lg">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        <img src="../img/es.png" class="img-carpet"> Idiomas <span class="caret"></span>
                      </a>
                    ...
                    <li class="visible-sm visible-md visible-lg">
                      <a class="btn btn-xl" title="Reservas | Smart Hotel Montevideo" href="https://be.synxis.com/?Hotel=36383&Chain=28734&locale=es-ES" target="_blank"><div class="extra-border">Reservas</div></a>
                    </li>
                  </ul>
            </div>
        </div>
    ...
    <div class="quick-contact">
      <a title="Reservas | Smart Hotel Montevideo" class="btn btn-xl book-now show-mobile" href="https://be.synxis.com/?Hotel=36383&Chain=28734&locale=es-ES" target="_blank"><div class="extra-border">Reservas</div></a>
      <a title="Teléfono | Smart Hotel Montevideo" class="btns show-mobile" href="tel:59842440229"><i class="fas fa-phone"></i></a>
