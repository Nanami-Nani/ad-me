...
//   setTimeout(function() {
//     // Show all .delay-block elements
//     document.querySelectorAll('.delay-block').forEach(function(el) {
...
// });
  ...
  gtag('config', 'G-MZMTM3Y68W');
    ...
    <link rel="stylesheet"
        ...
        href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700&amp;family=Poppins:wght@400;500;700&amp;display=swap" media="print"
  ...
  onload="this.media='all'">
    ...
    <link rel="stylesheet" type="text/css" href="assets/vendor/font-awesome/css/all.min.css" media="print" onload="this.onload=null;this.media='all';">
    <noscript>
        <link rel="stylesheet" type="text/css" href="assets/vendor/font-awesome/css/all.min.css">
    </noscript>
    ...
    <link rel="stylesheet" type="text/css" href="assets/vendor/bootstrap-icons/bootstrap-icons.css" media="print" onload="this.onload=null;this.media='all';">
    <noscript>
        <link rel="stylesheet" type="text/css" href="assets/vendor/bootstrap-icons/bootstrap-icons.css">
    </noscript>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="assets/vendor/font-awesome/css/all.min.css"> -->
    <link rel="stylesheet" type="text/css" href="assets/vendor/glightbox/css/glightbox.css" media="print" onload="this.onload=null;this.media='all';">
    <noscript>
        <link rel="stylesheet" type="text/css" href="assets/vendor/glightbox/css/glightbox.css">
    </noscript>
    ...
    <link rel="stylesheet" type="text/css" href="assets/vendor/flatpickr/css/flatpickr.min.css" media="print" onload="this.onload=null;this.media='all';">
    <noscript>
        <link rel="stylesheet" type="text/css" href="assets/vendor/flatpickr/css/flatpickr.min.css">
    </noscript>
    ...
    <style>
        ...
        /* .alert-warning > span  .text-decoration-underline {
            display: inline-flex;
            align-items: center;
        } */
         /* .loaded .min-height {
    ...
    $navdestsres = $footdestsres = $conn->query("SELECT * FROM destination ORDER BY CASE WHEN priority = 0 THEN 1 ELSE 0 END, priority LIMIT 5");
